...
class MainPageLocators:
    ...
    USER_AVATAR = (By.XPATH, "/html/body/div/div/div[1]/div/div[1]/button[@profileText name='User.']")
    USER_NAME = (By.XPATH, "html/body/div/div/div[1]/div/div[1]/div/h3[@profileText name='User.']")
...
class RegistrationPageLocators:
    ...
    ERROR_EMAIL =           (By.XPATH, "html/body/div/div/div[2]/div[5]/form/div[2]/div[1]/div/div[@class='input_inputError__fLUP9']")
    ERROR_PASSWORD =        (By.XPATH, "html/body/div/div/div[2]/div[5]/form/div[2]/div[2]/div/div[@class='input_inputError__fLUP9']")
    ERROR_SUBMIT_PASSWORD = (By.XPATH, "html/body/div/div/div[2]/div[5]/form/div[2]/div[3]/div/div[@class='input_inputError__fLUP9']")
    ERROR_TEXT_FIELD = (By.XPATH, "html/body/div/div/div[2]/div[5]/form/div[2]/div[1]/span[@input_span__yWPqB='Ошибка']")
...
class AdvertisementPageLocators:
    MODAL_TITLE = (By.XPATH, "html/body/div/div/div[2]/div[5]/form/div[1]/h1[text()='Чтобы разместить объявление, авторизуйтесь']")
    ITEM_NAME = (By.XPATH, "html/body/div/div/div[2]/div/form/div[2]/div[1]/div/div/input")
